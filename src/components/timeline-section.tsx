              ...
              <div className="flex flex-wrap items-center gap-x-3 gap-y-1 text-sm sm:text-base">
                <span className="inline-flex min-w-0 items-center gap-2">
                  {item.organizationLogoSrc ? (
                    <span className="timeline-org-icon relative inline-flex h-7 w-7 overflow-hidden border border-[color:var(--line)] bg-[color:var(--background-elevated)]">
                      <Image
                    ...
                    <span
                      aria-hidden
                      className="timeline-org-icon inline-flex h-7 w-7 items-center justify-center border border-[color:var(--line)] bg-[color:var(--background-elevated)] text-[color:var(--muted-foreground)]"
                    >
